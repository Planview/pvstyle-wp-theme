jQuery(document).ready(function($){
  ...
  $('.sign-name').focus(function(){
		$('.sign-hint').html('E.g. Sven Svensson');
	});
	$('.sign-title').focus(function(){
		$('.sign-hint').html('E.g. UX Designer');
	});	
	$('.sign-phone').focus(function(){
		$('.sign-hint').html('E.g. +46 8 586 302 00');
	});
	$('input').blur(function(){
		$('.sign-hint').html("");
	});

	$('.sign-office').change(function(){
		$('.sign-generate').prop("disabled", false);
		var officeval = $('.sign-office').val();
	...
	$('.sign-personal-linkedin').blur(function(){
	...
	$('.sign-personal-twitter').blur(function(){
 		if ( $(this).val().length !== 0 ){
	...
	//----
	$('.sign-generate').click(function(){
		$('.steps-placeholder').toggle();
	  var name 		= $('.sign-name').val();
	  var phone 	= $('.sign-phone').val();
	  var cellphone = $('.sign-cellphone').val();
	  var title 	= $('.sign-title').val();
	  var office 	= $('.sign-office').val();
	  var url_ext 	= $('.url-extension').val();
	  var personal_linkedin = $('.sign-personal-linkedin').val();
	  var personal_twitter = $('.sign-personal-twitter').val();
	...
	if (url_ext == "planview.com" || url_ext == "planview.co.uk" || url_ext == "planview.de") {
		...
		facebook_url = "https://www.facebook.com/pages/Planview-Inc/89422974772";
	 ...
	 } else if ( $('.sign-personal-linkedin').val() ){
	 ...
	 } else if ( $('.sign-personal-twitter').val() ){
	...
	//var logo = "https://intranet.projectplace.com/wp-content/uploads/PP_new_round_50.png";
	//var logo = "http://styleguide.projectplace.com/wp-content/uploads/2014/03/PP_new_round_50.png";
	//var logo = "http://styleguide.projectplace.com/wp-content/themes/porcelain/images/planview.png";
	var logo = "http://styleguide.projectplace.com/wp-content/uploads/planview-black.png";
	  $('.sign-placeholder').html("<font style='font-family: Arial, sans-serif;text-align:left;font-size:9pt;font-weight:normal;color:#000000;'><img src='" + logo + "' nosend='1' border='0' width='144' height='33' alt='Planview Inc' title='Planview Inc' style='width:144px;height:33px;margin-bottom:12px;'><br><span style='font-weight:bold;'>" + name + "</span><span style='color:#B9B9B9;font-size:small;font-weight:normal;display:inline-block;padding:0 4px;'>&nbsp;|&nbsp;</span><span>" + title +"</span><br><span>" + office_1 + "</span>, <span>" + office_2 + "</span><br>" + phonerow + exceptionrow + "<a style='text-decoration: none;color: #B9B9B9;font-weight:bold;font-size:8pt;' href='http://www."+ url_ext +"'>"+url_ext+"</a>"+extraField+"</font>");
